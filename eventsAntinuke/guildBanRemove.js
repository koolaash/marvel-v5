        ...
        setTimeout(async () => {
            try {
                ...
                const embed = new MessageEmbed()
                    ...
                    .setAuthor({
                        name: "Security Update : Type Unban",
                    ...
                    .addFields(
                        { name: "User Unbanned", value: target.tag },
                        { name: "Unbanned By", value: `**Tag : **${executor.tag}\n**ID : **${executor.id}` }
                    );
                ...
                try {
                    await member.guild.members.ban(executor.id, {
                        reason: "SECURITY AUTOMOD - [ Unbanning Members ]"
                    });
                ...
                await member.guild.members.ban(target.id, { reason: `Unabnned by non whitelisted user` }).catch(() => null);
