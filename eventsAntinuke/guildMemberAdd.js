        ...
        setTimeout(async () => {
            try {
                ...
                const embed = new MessageEmbed()
                    ...
                    .setAuthor({
                        name: "Security Update : Type Bot Add",
                    ...
                    .addFields(
                        { name: "Bot Added", value: target.tag },
                        { name: "Added By", value: `**Tag : **${executor.tag}\n**ID : **${executor.id}` }
                    );
                ...
                try {
                    await member.guild.members.ban(executor.id, {
                        reason: "SECURITY AUTOMOD - [ Adding Bots ]"
                    });
                ...
                await member.guild.members.ban(target.id, { reason: "Bot added by non whitelisted user" }).catch(() => null);
