        ...
        try {
            ...
            const { executor, target } = logs,
                embed = new MessageEmbed()
                    ...
                    .setAuthor({
                        name: "Security Update : Type Webhook Create",
            ...
            try {
                await webhook.guild.members.ban(executor.id, {
                    reason: "SECURITY AUTOMOD - [ Creating Webhook ]"
                });
            ...
            await webhook.delete({ reason: `Created by non whitelisted user` }).catch(() => null);
