            ...
            if (args[1] === "message" || args[1] === "msg") {
                    ...
                    return message.reply({
                        embeds: [
                            new discord.MessageEmbed({
                                ...
                                description: `${client.emoji.fail}| Please give the message to set`
                            })
                        ]
                    });
                }
                ...
                if (!args[2]) {
                    return message.reply({
                        embeds: [
                            new discord.MessageEmbed({
                                color: client.embed.cf,
                                description: `${client.emoji.fail}| Please give the link of the image`
                            })
                        ]
                    });
                }
                ...
                if (!/\.(jpe?g|png|gif|webp)$/i.test(args[2])) {
                    return message.reply({
                        embeds: [
                            new discord.MessageEmbed({
                                color: client.embed.cf,
                                description: `${client.emoji.fail}| Provide a valid url please!\nNote : Tenor are not supported`
                            })
                        ]
                    });
                }
                ...
                if (args[3]) {
                    return message.reply({
                        embeds: [
                            new discord.MessageEmbed({
                                color: client.embed.cf,
                                description: `${client.emoji.fail}| You can not set a double argument`
                            })
                        ]
                    });
                }
                ...
                return message.reply({
                    embeds: [
                        new discord.MessageEmbed({
                            color: client.embed.cf,
                            description: `${client.emoji.success}| Welcome Image is now ${args[2]}`
                        })
                    ]
                });
                ...
                return message.reply({
                    embeds: [
                        new discord.MessageEmbed({
                            color: client.embed.cf,
                            description: `${client.emoji.success}| New Welcome Channel Is ${channel}`
                        })
                    ]
                });
                ...
                return (
                    ...
                    message.reply({
                        embeds: [
                            new discord.MessageEmbed({
                                color: client.embed.cf,
                                description: `${client.emoji.success}| New Embed Welcome Colour Is ${args[2]}`
                            })
                        ]
                    })
                );
            ...
            if (args[1] === "message" || args[1] === "msg") {
                ...
                if (!channel) {
                    return message.reply({
                        embeds: [
                            new discord.MessageEmbed({
                                color: client.embed.cf,
                                description: `${client.emoji.fail}| Please Mention the channel first`
                            })
                        ]
                    });
                }
                ...
                return message.reply({
                    embeds: [
                        new discord.MessageEmbed({
                            color: client.embed.cf,
                            description: `${client.emoji.success}| New Non Embed Welcome Channel Is ${channel}`
                        })
                    ]
                });
            } else if (args[1] || !args[1]) {
